-- Update insert_field_repository function to include field_actions
...
-- Create update_field_repository function to handle field updates including field_actions
...
BEGIN
  ...
  -- Validate field exists and belongs to user or exists in the system
