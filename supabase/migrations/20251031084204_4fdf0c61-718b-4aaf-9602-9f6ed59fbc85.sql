-- Create comprehensive SCF notification system
...
-- 2. Program configuration notifications (create, update, delete)
...
-- 3. Invoice creation notifications (manual and upload)
...
BEGIN
  -- Only notify for completed auto-disbursements
...
-- 5. Manual finance disbursement notifications (via Finance Card)
...
-- 8. Repayment notifications (auto and manual)
