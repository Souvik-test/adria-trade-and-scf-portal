...
export const useManualBillsForm = () => {
  ...
  const submitForm = async () => {
    ...
    try {
      ...
      // Use a type assertion to bypass the TypeScript type mismatch
      // since bill_reference is auto-generated by the database trigger
      const insertData = {
        user_id: user.id,
      ...
      const { data, error } = await supabase
        ...
        .insert(insertData as any) // Type assertion to bypass TypeScript type mismatch
        .select()
        .single();
