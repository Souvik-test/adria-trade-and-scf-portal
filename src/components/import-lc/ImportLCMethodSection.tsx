...
interface ImportLCMethodSectionProps {
  selectedAction: ActionType;
  onMethodSelect: (method: string) => void;
}

const ImportLCMethodSection: React.FC<ImportLCMethodSectionProps> = ({
  selectedAction,
  onMethodSelect
}) => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <MethodCard
          ...
          description={selectedAction 
            ? 'Enter LC details manually through forms'
        ...
        <MethodCard
          title="Upload"
          description={selectedAction 
            ? 'Upload LC documents and auto-extract data'
            : 'Select an action above to enable methods'
          }
          icon={Upload}
          isEnabled={!!selectedAction}
...
export default ImportLCMethodSection;
