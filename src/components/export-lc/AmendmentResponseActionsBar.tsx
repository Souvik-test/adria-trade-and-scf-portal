...
interface AmendmentResponseActionsBarProps {
  handleDiscard: () => void;
  handleSaveDraft: () => void;
}

const AmendmentResponseActionsBar: React.FC<AmendmentResponseActionsBarProps> = ({
  handleDiscard,
  handleSaveDraft,
}) => (
...
export default AmendmentResponseActionsBar;
