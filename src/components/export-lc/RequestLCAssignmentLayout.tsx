...
const stepLabels = [
  "LC Information & Assignment Details",
  "Assignee & Documents"
];
...
const RequestLCAssignmentLayout: React.FC<Props> = ({
  stepIdx,
  requestId = "",
  setRequestId,
  children,
      ...
      <div className="flex items-center gap-4 mb-2 sm:mb-0">
        ...
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-foreground">
            Request LC Assignment
          </h1>
          <div className="text-sm text-muted-foreground">Assign LC proceeds to third party as per Article 39 UCP 600</div>
        </div>
      </div>
...
export default RequestLCAssignmentLayout;
