...
interface ResolveDiscrepanciesFormActionsProps {
  currentPane: number;
  onDiscard: () => void;
  onSaveAsDraft: () => void;
  onGoBack: () => void;
...
const ResolveDiscrepanciesFormActions: React.FC<ResolveDiscrepanciesFormActionsProps> = ({
  currentPane,
  onDiscard,
  onSaveAsDraft,
  onGoBack,
...
export default ResolveDiscrepanciesFormActions;
